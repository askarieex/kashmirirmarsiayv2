...
class _FullMarsiyaAudioPlayState extends State<FullMarsiyaAudioPlay>
  ...
  void initState() {
    super.initState();
    print(
      '🚀 Marsiya Player InitState: _viewCounted=$_viewCounted, audioId=${widget.audioId}',
    );
    ...
    try {
      ...
      if (result['success']) {
        ...
        if (mounted) {
          ...
          print(
            '🔄 Updating views: $views → $formattedViews (raw: $newViewCount)',
          );
          setState(() {
